...
return [
    ...
    */
    ...
    | views for crud. Default will be the "components.components.components.components.components.components.layouts.app".
    |
    */

    'layout' => 'components.components.components.components.components.components.layouts.app',
